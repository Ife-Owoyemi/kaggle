...
class PipelineManager:
    ...
    def FMMethod(self, object):
        ...
        if(object.STAGENAME != stage):
            raise TypeError,  object.name + " is not a valid parameter for the " + stage + "method because it is of stage " + object.stage + "\n"
        else:
            self.runMethod(object)
